  ...
  const projects = [
    {
      ...
      live: "#",
      AnimationData: "fade-up-right",
    },
    {
      title: "ZenHostify",
      date: "January 15, 2022 - March 2022",
      description:
        "A service hosting scheduler for pricing clients! Real-time services, and Cloud apps system using modern Interactive multi-platform system.",
      image: "/lovable-uploads/c8227586-0c86-47fa-ad7a-1c33a569fcb2.png",
      technologies: ["Vue.js", "Node.js", "MongoDB", "Docker"],
      live: "#",
      AnimationData: "fade-up-left",
    },
  ];
        ...
        <div className="space-y-16">
          {projects.map((project, index) => (
            <div key={index} className="space-y-6">
              ...
              {/* Project Image */}
              <div
                data-aos={project.AnimationData}
